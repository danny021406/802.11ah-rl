...
CFLAGS_PYEMBED = ['-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-fwrapv']
CFLAGS_PYEXT = ['-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-fwrapv']
CXXFLAGS_PYEXT = ['-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
ENABLE_ZMQ = True
EXAMPLE_DIRECTORIES = ['ipv6', 'realtime', 'socket', 'udp-client-server', 'stats', 'tcp', 'routing', 'naming', 'udp', 'error-model', 'energy', 'wireless', 'tutorial', 'matrix-topology']
...
LIB_PYEMBED = ['python3.6m', 'pthread', 'dl', 'util', 'm']
LIB_PYEXT = ['python3.6m', 'pthread', 'dl', 'util', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
LIB_ZMQ = ['zmq']
...
NS3_EXECUTABLE_PATH = ['/tf/IEEE-802.11ah-ns-3/build/src/fd-net-device', '/tf/IEEE-802.11ah-ns-3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/tf/IEEE-802.11ah-ns-3/build']
...
PYTHON_CONFIG = ['/usr/bin/python3.6-config']
PYTHON_VERSION = '3.6'
...
cfg_files = ['/tf/IEEE-802.11ah-ns-3/build/ns3/config-store-config.h', '/tf/IEEE-802.11ah-ns-3/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
