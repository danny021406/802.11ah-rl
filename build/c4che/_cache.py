...
NS3_EXECUTABLE_PATH = ['/tf/802.11ah-rl/build/src/fd-net-device', '/tf/802.11ah-rl/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/tf/802.11ah-rl/build']
...
cfg_files = ['/tf/802.11ah-rl/build/ns3/config-store-config.h', '/tf/802.11ah-rl/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
